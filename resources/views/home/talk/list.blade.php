    ...
    <div class="uc-box uc-main-box">
        <div class="uc-content-box">
            ...
            <div style="float-right" class="box-hd">
                <a href="{{ url('home/talk/list') }}"><h4 style="font-size:16px" class="title">作为买家收到的信息</h4></a>
            </div>
...
<script language="javascript" type="text/javascript">
     ...
     {
         var someValue=window.showModalDialog("{{ url('home/model/index') }}","","dialogWidth=500px;dialogHeight=500px;status=no;help=no;scrollbars=no");
