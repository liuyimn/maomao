<!DOCTYPE html>
<!-- saved from url=(0044)http://www.sucaihuo.com/modals/17/1740/demo/ -->
...
.error_left{ margin: 120px 0 0 50px; width: 330px ; height: 345px; background: url('/home/config/timg.png') no-repeat;     background-size: 100%;float: left;}
	...
	<div class="error_content">
		...
		<div class="error_right">
			<div class="error_detail">
				<p class="error_p_title">哎呦~ 网站正在维护!</p>
				<p class="error_p_con">●别急，工程师正在紧急处理，马上就好。</p>
				<p class="error_p_con">●您可致电10086,通知开发人员!</p>
