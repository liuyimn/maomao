    ...
    <body data-spm="1">
        <div id="page">
            <div id="content" class="grid-c">
                ...
                <!--订单提交开始-->
                <form id="J_Form" name="J_Form" action="{{ url('/home/num/my/insert') }}" method="post">
                    <div>
                        ...
                        {{ csrf_field() }}
                            <tbody data-spm="3" class="J_Shop" data-tbcbid="0" data-outorderid="47285539868"  data-isb2c="false" data-postMode="2" data-sellerid="1704508670">
                                ...
                                <tr class="shop blue-line">
                                    <td colspan="3">
                                        卖家：<a class="J_ShopName J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.6" href="http://store.taobao.com/shop/view_shop.htm?shop_id=104337282"
                                        target="_blank" title="{{ $v->nickname }}">{{ $v->nickname }}</a>
                                ...
                                <tr class="item" data-lineid="19614514619:31175333266:35612993875" data-pointRate="0">
                                    <td class="s-title">
                                        <a href="#" target="_blank" title="{{ $v->connect }}" class="J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.5">
                                            <img src="{{ url('/uploads/shop') }}/{{ $v->pic }}" class="itempic">
